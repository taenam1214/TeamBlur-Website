      ...
      <div className="features-intro">
        ...
        <p>
          ...
          <span className="line-break">
            where college students can connect{" "}
          </span>
          <span className="line-break">
      ...
      <div className="features-section">
        ...
        <div className="feature">
          ...
          <div className="feature-text">
            ...
            <p>
              Share your campus life anonymously and explore other campus
              students&apos; lives across the states.
            </p>
        ...
        <div className="feature feature-reversed">
          ...
          <div className="feature-text">
            ...
            <p>
              Get the info and advice you need through topic-based channels.
              Whether it’s academics, social life, or career tips, join
              discussions that help you grow.
            </p>
          </div>
        </div>
      </div>
