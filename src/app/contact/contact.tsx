  ...
  const handleSocialClick = (event: React.MouseEvent<HTMLAnchorElement>, webUrl: string, appUrl: string) => {
    if (typeof window !== "undefined" && navigator.userAgent) {
      ...
      if (isMobile) {
        ...
        // Desktop: Go directly to web URL without delay
        ...
        <div className="right-section">
          <div className="contact-info">
            ...
            <div className="social-icons">
              {/* LinkedIn */}
              <a 
                href="https://www.linkedin.com/company/blurapp" 
                target="_blank" 
              ...
              {/* Instagram */}
              <a 
                href="https://www.instagram.com/blurapp.io/" 
                target="_blank" 
                rel="noopener noreferrer"
